...
public class MountService {
    ...
    public void handleMount(String npcName) {
        handleMount(worldInternal.createNpc(npcName, player));
    }
    ...
    public void handleUnmount() {
        ...
        if (mountItem != null) {
            final var npc = worldInternal.createNpc(mountItem.getMountNpc(), player);

            npc.setDirection(player.getDirection());
            player.unequipItem(mountItem);

            worldInternal.deleteItem(mountItem);
