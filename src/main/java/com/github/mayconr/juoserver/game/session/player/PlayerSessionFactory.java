...
import com.github.mayconr.juoserver.game.session.player.item.PlayerItemServiceImpl;
...
public class PlayerSessionFactory {
    ...
    public PlayerSession createPlayerSession(UOPlayer player, SessionOutbound outbound, SessionFanout fanout) {
        ...
        final var itemService = new PlayerItemServiceImpl(player, fanout, outbound, storage, policyService);
