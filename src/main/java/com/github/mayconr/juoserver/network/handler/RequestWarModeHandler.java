...
public class RequestWarModeHandler extends PlayerSessionChannelInboundHandler<RequestWarMode> {
    ...
    @Override
    protected void channelRead0(PlayerSession session, SessionOutbound outbound, RequestWarMode msg) {
        world.toggleWarMode((UOPlayer) session.getPlayer(), msg.getType());
    }
}
