...
public class MiningConfiguration {
    ...
    @Bean
    public UseMiningTool useMiningTool(WorldActions worldActions, WorldView worldView, SkillSystem skillSystem, ResourceRoller resourceRoller) {
        return new UseMiningTool(worldActions, worldView, skillSystem, resourceRoller);
    }
}
